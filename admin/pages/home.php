                ...
                <div class="nav_list"> 
                    ...
                    <i class='bx bx-user nav_icon'></i>
                     <span class="nav_name">Patients</span> </a>
                         ...
                         <a href="?page=queries" class="nav_link" style="text-decoration:none;">
                         <i class='bx bx-chat'></i>
                          <span class="nav_name">Queries</span> </a> 
                </div>
            </div> 
            <!-- <a href="http://localhost:8080/AIP/pages/logout.php"  class="nav_link" style="text-decoration:none;">  -->
                <a href class="nav_link" style="text-decoration:none;" data-bs-toggle="modal" data-bs-target="#logout"> <i class='bx bx-log-out nav_icon'></i> <span class="nav_name">Sign Out</span>
                </a>
        </nav>
    </div>
