...
include 'connection.php';
  $patientquery="SELECT * FROM `patient` where username='$_SESSION[username]'";
...
<div class="container-fluid-0 mt-4 pb-4">
   ...
   <table class="table display" id="myTable">
        ...
        <tbody>
                <?php  
                $fetchq="SELECT * from `patient` INNER JOIN `appointment_list` on patient.patient_id=appointment_list.patient_id where patient.username='$_SESSION[username]'";
